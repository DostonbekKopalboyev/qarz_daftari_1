        ...
        <form action="{{route('admins.store')}}" method="POST" style="width: 30vw;" >
            ...
            <div class="mb-3" >
                ...
                <div class="md-3">
                    ...
                    <input type="text" class="form-control my-6" name="phone" placeholder="Customer phone"></input>
                </div>
                <br>
                <div class="md-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="description"  placeholder="Customer description">
                </div>
                <div class="mb-3">
                    <label class="form-label">Customer debt: </label>
                    <input type="number" class="form-control" name="debt"  placeholder="Customer debt">
                </div>
                <div class="mb-3">
                    <label class="form-label">Customer status: </label>
                    <input type="number" class="form-control" name="ststus"  placeholder="Customer status">
                </div>
            </div>
            <br>
            <div>
